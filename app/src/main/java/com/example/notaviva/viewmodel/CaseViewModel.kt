...
class CaseViewModel(
     ...
     */
    val allInterviewsWithCases:
            StateFlow<List<InterviewWithCase>> =

        repository
            .getAllInterviewsWithCases()
            .stateIn(
                viewModelScope,
                SharingStarted.WhileSubscribed(5000),
                emptyList()
    ...
    fun getInterviews(
        caseId: Long
    ): StateFlow<List<InterviewEntity>> =
